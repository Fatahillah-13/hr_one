...
const IconGrid = () => {
    ...
    const outerIcons = [
        ...
        {
            id: 2,
            component: <TailgridsLogo />,
        },
        {
            id: 3,
            component: <UideckLogo />,
        },
        {
            id: 4,
            component: <GrayGridsLogo />,
        },
        {
            id: 5,
            component: <StaticRunLogo />,
        },
        {
            id: 6,
            component: <NextJsTemplatesLogo />,
        },
        {
            id: 7,
            component: <LineIconsLogo />,
        },
    ];
    const radius = 160;
            ...
            >
                ...
                <g>
                    ...
                    {outerIcons.map((icon, i) => {
                        ...
                        const angle1 =
                            (-90 + i * (360 / outerIcons.length)) *
                            (Math.PI / 180);
                        const x1 =
                            svgCenter +
                            (radius - outerIconRadius) * Math.cos(angle1);
                        const y1 =
                            svgCenter +
                            (radius - outerIconRadius) * Math.sin(angle1);
                        const angle2 =
                            (-90 + nextIndex * (360 / outerIcons.length)) *
                            (Math.PI / 180);
                        const x2 =
                            svgCenter +
                            (radius - outerIconRadius) * Math.cos(angle2);
                        const y2 =
                            svgCenter +
                            (radius - outerIconRadius) * Math.sin(angle2);
                        const isLineActive =
                    ...
                    {outerIcons.map((icon, i) => {
                        ...
                        const startX =
                            svgCenter +
                            centralIconRadius * Math.cos(angleInRadians);
                        const startY =
                            svgCenter +
                            centralIconRadius * Math.sin(angleInRadians);
                        const endX =
                            svgCenter +
                            (radius - outerIconRadius) *
