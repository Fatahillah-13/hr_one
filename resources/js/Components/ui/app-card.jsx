...
export default function AppCard({
    ...
    return (
        <article
            onClick={handleClick}
            className={cn(
                "w-full max-w-[320px] rounded-[16px] bg-white px-[18px] py-[16px] shadow-[0px_0px_1px_0px_rgba(12,26,75,0.24),0px_3px_8px_0px_rgba(50,50,71,0.05)] cursor-pointer transition-all duration-300 hover:shadow-[0px_8px_16px_0px_rgba(12,26,75,0.35)] hover:-translate-y-2",
                className
            )}
        >
